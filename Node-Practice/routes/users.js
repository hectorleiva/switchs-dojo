...
router.put('/user', async(req, res) => {
  ...
  if (req.body.user_name) {
    var udate = await db.query (`update users set user_name = '${req.body.user_name}' where id = ${req.query.id}`)
  }
  if(req.body.first_name) {
    var udate = await db.query (`update users set first_name = '${req.body.first_name}' where id = ${req.query.id}`)
  }
...
app.put('/orders/pizza_id', (req, res) => {
    ...
    res.json({ message: `Pizza with ID: ${pizza_Id} updated!`, pizza: updatedPizza });
});
